                ...
                <div className="header_container">
                    <div className="left_section">
                        {window.innerWidth <= 768 ?
                            <AiOutlineMenuFold id="manimage" className="profile_icon" onClick={handleSidebarToggle} />
                            :
                            <AiOutlineMenuFold id="manimageclose" className="profile_icon" onClick={handleCollapsesidebar} />
                        }
            ...
            {(roleid === null || roleid === "2") && (
                <div className="header_container">
                    ...
                    <div>
                        <>
                            {!backicon && (
                                <BiArrowBack size={18} style={{ cursor: "pointer" }} onClick={handleBackClick} />
                            )}
                        </>

                        <label style={{ fontWeight: "bold", marginLeft: "10px" }}>{title}</label>
                    </div>
                    ...
                    {!isAdminLogin && (
                        <div style={{ display: "flex", flexDirection: "row", gap: "10px" }}>
                            ...
                            <div onClick={handleProfileClick} className="profile_icon_container">
