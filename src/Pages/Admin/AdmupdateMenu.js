...
const AdmupdateMenu = (props) => {
    ...
    const handleUpdate = () => {
        ...
        const url = "/product/saveOrUpdateProduct";
                ...
                <div className={sideBarCollapse ? "main_content" : "main_content collapsed"}>
                    <div className="Summary_card">
                        ...
                        <div className='row' style={{ marginTop: "20px", rowGap: "10px" }}>
                            <div className="col-lg-4 col-md-12">
                                <div className='input_contanier'>
                                    <label className="admaddmenu_label">Product Name <span className='required' style={{ color: "red" }}>*</span></label>
                                    <input
                                        type="text"
                                        id="name"
                                        name="name"
                            ...
                            <div className="col-lg-4 col-md-12">
                                <div className='input_contanier'>
                                    <label className="admaddmenu_label">Product Desciption <span className='required' style={{ color: "red" }}>*</span></label>
                                    <input
                                        type="text"
                                        id="name"
                                        name="name"
                            ...
                            <div className="col-lg-4 col-md-12">
                                <div className='input_contanier'>
                                    <label className="admaddmenu_label">Price <span className='required' style={{ color: "red" }}>*</span></label>
                                    <input
                                        type="text"
                                        id="name"
                                        name="name"
                            ...
                            <div className='col-lg-4 col-md-12' >
                                <div className='input_contanier'>
                                    <label className='admaddmenu_label'>Product Image<span className="required" style={{ color: "red" }}>*</span></label>
                                    <input
                                        id="firstSignImg"
                                        name="firstSignImg"
                                        type="file"
                        ...
                        <div style={{ display: "flex", gap: "10px" }}>
                            <button type="button" onClick={() => handleUpdate()} className="btnmenu" style={{ marginTop: "40px" }}>
                                Update
                            </button>
                            <button type="button" onClick={() => navigate(-1)} className="btnmenu" style={{ marginTop: "40px" }}>
                                Back
                            </button>
                        </div>
                    </div>
